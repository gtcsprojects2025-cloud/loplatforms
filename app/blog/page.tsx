...
export const generateMetadata = (): Metadata => {
  return {
    title: "Blog | Web Application Development & Digital Strategy Insights | Lagos, Nigeria",
    description: "Practical guides on web application development, custom software, timelines, and digital strategy for businesses and founders in Lagos, Nigeria.",
    keywords: [
      "web application development", "web app vs website", "web application vs WordPress",
      "Lagos web development", "Nigeria web application company", "custom software Nigeria",
      "how long to build a web app", "MVP development Lagos", "Nigerian payment integration",
      "web app cost Nigeria"
    ],
    authors: [{ name: "LOPublications" }],
    openGraph: {
      title: "Blog - Web Application Development & Digital Strategy Insights",
      description: "Discover practical guides on web application development, custom software, timelines, and digital strategy for Lagos businesses.",
      images: [{ url: blogPosts[0].image, alt: "Web Application Development Blog" }],
      locale: "en_NG",
      type: "website",
    },
    twitter: {
