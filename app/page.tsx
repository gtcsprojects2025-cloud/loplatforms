...
If you're ready to explore how the LO Platform can support your operations, start here:</p>
                  <button onClick={() => navigateTo('contact')} className="mt-8 border border-white/30 px-8 py-4 uppercase font-black tracking-widest text-xs hover:bg-white hover:text-slate-950 transition-all">Contact Our Architects</button>
                </div>
            </section>
            </>
          );
